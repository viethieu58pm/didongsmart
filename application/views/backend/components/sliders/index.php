									...
									<?php foreach ($list as $row):?>
										<tr>
											...
											<td class="text-center">
												<a href="<?php echo base_url() ?>admin/sliders/status/<?php echo $row['id'] ?>">
													...
													<td class="text-center">
														<?php
														if($user['role']==1){
															echo '<a class="btn btn-success btn-xs" href="'.base_url().'admin/sliders/update/'.$row['id'].'" role = "button">
											...
											<td class="text-center">
												<?php
														if($user['role']==1){
															echo '<a class="btn btn-danger btn-xs" href="'.base_url().'admin/sliders/trash/'.$row['id'].'" role = "button">
