									...
									<tbody>
										<?php foreach ($list as $row): ?>
											<tr>
												...
												<td class="text-center">
												<a class="btn btn-danger btn-xs" href="admin/contact/delete/<?php echo $row['id'] ?>" onclick="return confirm('Xác nhận xóa ?')" role = "button">
													<span class="glyphicon glyphicon-edit"></span>Xóa VV
												</a>
											</td>
												<!-- <?php  
												$quyen='';
