					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
							...
							<div class="fk-boxs" id="km-all" data-comt="False">
								<div id="km-detail">
									<p class="fk-tit"><i class="fas fa-gift " ></i>  Khuyến mại</p>
									<div class="fk-main">
										<div class="fk-sales">
											</ul>
											<ul>
												<li>1. Tặng Voucher Phụ Kiện 1,000,000đ (khi phiếu mua hàng trên 10,000,000 đ).</li>
											</ul>
											<ul>
												<li>2. Tặng: Cường lực - Ốp lưng - Tai nghe khi mua BHV.
												</li>
											</ul>
											<ul>
												<li>3. Giảm 100K áp dụng HSSV mua BHV.
												</li>
											</ul>
											<ul>
												<li>4. Nguyên hộp. Đầy đủ phụ kiện từ nhà sản xuất.
												</li>
											</ul>
											<ul>
												<li>5. Bảo hành 12 tháng. 1 đổi 1 trong 30 ngày nếu có lỗi nhà sản xuất.
												</li>
											</ul>
